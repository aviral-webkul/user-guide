...
<ImagePopup src="/images/multi-vendor-marketplace/1-seller-attributes.webp" alt="Seller Attributes" />

Admins can easily view all existing seller attributes and create new ones as needed for sellers.

<ImagePopup src="/images/multi-vendor-marketplace/2-admin-create-seller-attribute.webp" alt="Seller Attributes" />
...
<ImagePopup src="/images/multi-vendor-marketplace/3-seller-attribute-mapping.webp" alt="Mapping of the Seller Attributes" />
...
<ImagePopup src="/images/multi-vendor-marketplace/4-bagisto-openshop-e.webp" alt="Seller Dashboard" />
...
<ImagePopup src="/images/multi-vendor-marketplace/5-seller-register.webp" alt="Seller Dashboard" />

Add the additional information, and after filling in all the required details, click the **Register** button.

<ImagePopup src="/images/multi-vendor-marketplace/6-attribute-shop-sign-up.webp" alt="Seller Dashboard" />
...
<ImagePopup src="/images/multi-vendor-marketplace/7-bagisto-mp.webp" alt="Seller Dashboard" />
